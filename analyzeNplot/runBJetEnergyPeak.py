...
def runBJetEnergyPeak(inFileURL, outFileURL, xsec=None):
    ...
    histos={
        ...
        'bjet_en_ls_MED':ROOT.TH1F('bjet_en_ls_MED',';log(E);  1/E dN_{b jets}/dlog(E)',80,3.,7.),
        'bjet_en_LOO':ROOT.TH1F('bjet_en_LOO',';Energy [GeV]; Jets',50,0,400),
        'bjet_en_ls_LOO':ROOT.TH1F('bjet_en_ls_LOO',';log(E);  1/E dN_{b jets}/dlog(E)',80,3.,7.),
        'bjet_en_TIG':ROOT.TH1F('bjet_en_TIG',';Energy [GeV]; Jets',50,0,400),
        'bjet_en_ls_TIG':ROOT.TH1F('bjet_en_ls_TIG',';log(E);  1/E dN_{b jets}/dlog(E)',80,3.,7.),
#########################################################################################
