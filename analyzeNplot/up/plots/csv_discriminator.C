...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.1445783,-37298.05,1.060241,273519.8);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__113->SetMaximum(270411.7);
   frame__113->SetEntries(146851);
   ...
   mc_stack_17->SetMaximum(218409.4);
   ...
   csv_discriminator_t#bar{t}__114->SetBinContent(0,6612.666);
   csv_discriminator_t#bar{t}__114->SetBinContent(1,198848.2);
   csv_discriminator_t#bar{t}__114->SetBinContent(2,57582.38);
   csv_discriminator_t#bar{t}__114->SetBinContent(3,70476.34);
   csv_discriminator_t#bar{t}__114->SetBinContent(4,133785.3);
   csv_discriminator_t#bar{t}__114->SetBinError(0,160.112);
   csv_discriminator_t#bar{t}__114->SetBinError(1,876.4311);
   csv_discriminator_t#bar{t}__114->SetBinError(2,471.7288);
   csv_discriminator_t#bar{t}__114->SetBinError(3,521.9779);
   csv_discriminator_t#bar{t}__114->SetBinError(4,719.2089);
   csv_discriminator_t#bar{t}__114->SetEntries(129930);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__119->SetEntries(146851);
   ...
   Graph_Graph_from_ratio3034->SetMinimum(0.8517042);
   Graph_Graph_from_ratio3034->SetMaximum(0.8944873);
