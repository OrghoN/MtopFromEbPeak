...
// ------------>Primitives in pad: p1
   ...
   cut_flow_t#bar{t}__149->SetBinContent(3,134967.4);
   cut_flow_t#bar{t}__149->SetBinContent(4,134900.4);
   cut_flow_t#bar{t}__149->SetBinError(1,1046.527);
   cut_flow_t#bar{t}__149->SetBinError(2,950.8118);
   cut_flow_t#bar{t}__149->SetBinError(3,848.8089);
   cut_flow_t#bar{t}__149->SetBinError(4,848.6085);
   cut_flow_t#bar{t}__149->SetEntries(129348);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__154->SetEntries(182125);
   ...
   Graph_Graph_from_ratio3044->SetMinimum(0.9138895);
   Graph_Graph_from_ratio3044->SetMaximum(0.9679017);
