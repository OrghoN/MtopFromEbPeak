...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.5783133,-25427.92,4.240964,186472.2);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__29->SetMaximum(184353.2);
   frame__29->SetEntries(32767);
   ...
   mc_stack_5->SetMaximum(148900.7);
   ...
   nleptons_t#bar{t}__30->SetBinContent(6,134900.4);
   nleptons_t#bar{t}__30->SetBinError(6,848.6085);
   nleptons_t#bar{t}__30->SetEntries(27079);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__35->SetEntries(32767);
   ...
   Graph_Graph_from_ratio3010->SetMaximum(1.023836);
