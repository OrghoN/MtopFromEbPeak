...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.1445783,-35248.39,1.060241,258489);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__113->SetMaximum(255551.7);
   frame__113->SetEntries(105365);
   ...
   mc_stack_17->SetMaximum(206407.1);
   ...
   csv_discriminator_t#bar{t}__114->SetBinContent(0,6321.479);
   csv_discriminator_t#bar{t}__114->SetBinContent(1,187417.5);
   csv_discriminator_t#bar{t}__114->SetBinContent(2,54115.19);
   csv_discriminator_t#bar{t}__114->SetBinContent(3,64939.72);
   csv_discriminator_t#bar{t}__114->SetBinContent(4,127467.3);
   csv_discriminator_t#bar{t}__114->SetBinError(0,183.3885);
   csv_discriminator_t#bar{t}__114->SetBinError(1,999.7187);
   csv_discriminator_t#bar{t}__114->SetBinError(2,537.407);
   csv_discriminator_t#bar{t}__114->SetBinError(3,588.4821);
   csv_discriminator_t#bar{t}__114->SetBinError(4,825.27);
   csv_discriminator_t#bar{t}__114->SetEntries(88444);
   ...
   csv_discriminator_DY__116->SetBinContent(0,50.51452);
   csv_discriminator_DY__116->SetBinContent(1,405.9186);
   csv_discriminator_DY__116->SetBinContent(2,50.00715);
   csv_discriminator_DY__116->SetBinContent(3,260.9279);
   csv_discriminator_DY__116->SetBinContent(4,164.09);
   csv_discriminator_DY__116->SetBinError(0,29.43275);
   csv_discriminator_DY__116->SetBinError(1,83.64881);
   csv_discriminator_DY__116->SetBinError(2,28.93178);
   ...
   csv_discriminator_SinglesPtop__118->SetBinContent(1,8475.438);
   csv_discriminator_SinglesPtop__118->SetBinContent(2,2159.924);
   csv_discriminator_SinglesPtop__118->SetBinContent(3,2872.103);
   csv_discriminator_SinglesPtop__118->SetBinContent(4,5211.137);
   csv_discriminator_SinglesPtop__118->SetBinError(0,19.70751);
   csv_discriminator_SinglesPtop__118->SetBinError(1,106.4394);
   csv_discriminator_SinglesPtop__118->SetBinError(2,53.76695);
   csv_discriminator_SinglesPtop__118->SetBinError(3,62.083);
   csv_discriminator_SinglesPtop__118->SetBinError(4,83.46794);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__119->SetEntries(105365);
   ...
   Graph_Graph_from_ratio3034->SetMinimum(0.8891283);
   Graph_Graph_from_ratio3034->SetMaximum(0.9606624);
