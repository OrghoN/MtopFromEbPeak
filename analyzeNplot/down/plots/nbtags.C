...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(0.2108434,-16070.91,2.620482,117854.1);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__92->SetMaximum(116514.9);
   frame__92->SetEntries(32767);
   ...
   mc_stack_14->SetMaximum(94108.19);
   ...
   nbtags_t#bar{t}__93->SetBinContent(1,84276.49);
   nbtags_t#bar{t}__93->SetBinContent(2,50623.55);
   nbtags_t#bar{t}__93->SetBinError(1,670.5782);
   nbtags_t#bar{t}__93->SetBinError(2,520.0589);
   nbtags_t#bar{t}__93->SetEntries(27079);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__98->SetEntries(32767);
   ...
   Graph_Graph_from_ratio3028->SetMinimum(0.893601);
   Graph_Graph_from_ratio3028->SetMaximum(0.9464701);
