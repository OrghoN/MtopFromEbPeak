...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.1445783,-41324.97,1.060241,303050.6);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__113->SetMaximum(299606.8);
   frame__113->SetEntries(1286096);
   ...
   mc_stack_17->SetMaximum(241990.1);
   ...
   csv_discriminator_t#bar{t}__114->SetBinContent(0,7140.752);
   csv_discriminator_t#bar{t}__114->SetBinContent(1,216843.3);
   csv_discriminator_t#bar{t}__114->SetBinContent(2,72954.93);
   csv_discriminator_t#bar{t}__114->SetBinContent(3,63591.29);
   csv_discriminator_t#bar{t}__114->SetBinContent(4,122073);
   csv_discriminator_t#bar{t}__114->SetBinContent(5,0.815666);
   csv_discriminator_t#bar{t}__114->SetBinError(0,54.14972);
   csv_discriminator_t#bar{t}__114->SetBinError(1,298.4562);
   csv_discriminator_t#bar{t}__114->SetBinError(2,173.1489);
   csv_discriminator_t#bar{t}__114->SetBinError(3,161.5943);
   csv_discriminator_t#bar{t}__114->SetBinError(4,223.9315);
   csv_discriminator_t#bar{t}__114->SetBinError(5,0.509084);
   csv_discriminator_t#bar{t}__114->SetEntries(1262039);
   ...
   csv_discriminator_Diboson__115->SetBinContent(0,38.08094);
   csv_discriminator_Diboson__115->SetBinContent(1,1228.504);
   csv_discriminator_Diboson__115->SetBinContent(2,704.2424);
   csv_discriminator_Diboson__115->SetBinContent(3,125.685);
   csv_discriminator_Diboson__115->SetBinContent(4,65.15427);
   csv_discriminator_Diboson__115->SetBinError(0,3.854437);
   csv_discriminator_Diboson__115->SetBinError(1,21.90692);
   csv_discriminator_Diboson__115->SetBinError(2,16.59529);
   csv_discriminator_Diboson__115->SetBinError(3,6.965481);
   csv_discriminator_Diboson__115->SetBinError(4,5.03309);
   csv_discriminator_Diboson__115->SetEntries(6063);
   ...
   csv_discriminator_SinglesPtop__118->SetBinContent(0,339.6512);
   csv_discriminator_SinglesPtop__118->SetBinContent(1,10353.66);
   csv_discriminator_SinglesPtop__118->SetBinContent(2,3646.48);
   csv_discriminator_SinglesPtop__118->SetBinContent(3,2746.146);
   csv_discriminator_SinglesPtop__118->SetBinContent(4,4977.875);
   csv_discriminator_SinglesPtop__118->SetBinError(0,21.51549);
   csv_discriminator_SinglesPtop__118->SetBinError(1,117.6246);
   csv_discriminator_SinglesPtop__118->SetBinError(2,69.84896);
   csv_discriminator_SinglesPtop__118->SetBinError(3,60.65226);
   csv_discriminator_SinglesPtop__118->SetBinError(4,81.58884);
   csv_discriminator_SinglesPtop__118->SetEntries(17809);
   ...
   Graph_Graph_from_csv_discriminator3033->SetMaximum(238374.4);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__119->SetEntries(1286096);
   ...
   Graph_Graph_from_ratio3034->SetMinimum(0.8810761);
   Graph_Graph_from_ratio3034->SetMaximum(0.9561768);
