...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.5783133,-28594.91,4.240964,209696.8);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__29->SetMaximum(207313.9);
   frame__29->SetEntries(400660);
   ...
   mc_stack_5->SetMaximum(167445.8);
   ...
   nleptons_t#bar{t}__30->SetBinContent(6,150106.3);
   nleptons_t#bar{t}__30->SetBinError(6,248.3215);
   nleptons_t#bar{t}__30->SetEntries(392482);
   ...
   nleptons_Diboson__31->SetBinContent(6,734.277);
   nleptons_Diboson__31->SetBinError(6,16.92699);
   nleptons_Diboson__31->SetEntries(2062);
   ...
   nleptons_SinglesPtop__34->SetBinContent(6,7502.981);
   nleptons_SinglesPtop__34->SetBinError(6,100.1731);
   nleptons_SinglesPtop__34->SetEntries(6054);
   ...
   Graph_Graph_from_nleptons3009->SetMaximum(163304.7);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__35->SetEntries(400660);
   ...
   Graph_Graph_from_ratio3010->SetMaximum(1.024788);
