...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(0.2108434,-15131.8,2.620482,110967.4);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__92->SetMaximum(109706.4);
   frame__92->SetEntries(400660);
   ...
   mc_stack_14->SetMaximum(88608.98);
   ...
   nbtags_t#bar{t}__93->SetBinContent(1,69024.43);
   nbtags_t#bar{t}__93->SetBinContent(2,81083.22);
   nbtags_t#bar{t}__93->SetBinError(1,168.3897);
   nbtags_t#bar{t}__93->SetBinError(2,182.5061);
   nbtags_t#bar{t}__93->SetEntries(392482);
   ...
   nbtags_Diboson__94->SetBinContent(1,640.6523);
   nbtags_Diboson__94->SetBinContent(2,93.62474);
   nbtags_Diboson__94->SetBinError(1,15.81108);
   nbtags_Diboson__94->SetBinError(2,6.044237);
   nbtags_Diboson__94->SetEntries(2062);
   ...
   nbtags_DY__95->SetBinContent(1,673.4524);
   nbtags_DY__95->SetBinContent(2,155.8412);
   nbtags_DY__95->SetBinError(1,107.0998);
   nbtags_DY__95->SetBinError(2,52.04371);
   ...
   nbtags_SinglesPtop__97->SetBinContent(1,4652.446);
   nbtags_SinglesPtop__97->SetBinContent(2,2850.536);
   nbtags_SinglesPtop__97->SetBinError(1,78.83595);
   nbtags_SinglesPtop__97->SetBinError(2,61.80244);
   nbtags_SinglesPtop__97->SetEntries(6054);
   ...
   Graph_Graph_from_nbtags3027->SetMaximum(88326.55);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__98->SetEntries(400660);
   ...
   Graph_Graph_from_ratio3028->SetMinimum(0.8969223);
   Graph_Graph_from_ratio3028->SetMaximum(0.957488);
