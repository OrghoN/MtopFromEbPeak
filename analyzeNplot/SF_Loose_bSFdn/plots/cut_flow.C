...
// ------------>Primitives in pad: p1
   ...
   cut_flow_t#bar{t}__149->SetBinContent(3,150212);
   cut_flow_t#bar{t}__149->SetBinContent(4,150106.3);
   cut_flow_t#bar{t}__149->SetBinError(1,292.9197);
   cut_flow_t#bar{t}__149->SetBinError(2,266.9722);
   cut_flow_t#bar{t}__149->SetBinError(3,248.4085);
   cut_flow_t#bar{t}__149->SetBinError(4,248.3215);
   cut_flow_t#bar{t}__149->SetEntries(1785183);
   ...
   cut_flow_Diboson__150->SetBinContent(3,734.277);
   cut_flow_Diboson__150->SetBinContent(4,734.277);
   cut_flow_Diboson__150->SetBinError(1,45.58919);
   cut_flow_Diboson__150->SetBinError(2,31.66543);
   cut_flow_Diboson__150->SetBinError(3,16.92699);
   cut_flow_Diboson__150->SetBinError(4,16.92699);
   cut_flow_Diboson__150->SetEntries(26391);
   ...
   cut_flow_SinglesPtop__153->SetBinContent(3,7509.633);
   cut_flow_SinglesPtop__153->SetBinContent(4,7502.981);
   cut_flow_SinglesPtop__153->SetBinError(1,135.785);
   cut_flow_SinglesPtop__153->SetBinError(2,110.2191);
   cut_flow_SinglesPtop__153->SetBinError(3,100.2174);
   cut_flow_SinglesPtop__153->SetBinError(4,100.1731);
   cut_flow_SinglesPtop__153->SetEntries(30566);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__154->SetEntries(1842941);
   ...
   Graph_Graph_from_ratio3044->SetMinimum(0.9231465);
   Graph_Graph_from_ratio3044->SetMaximum(0.9481581);
