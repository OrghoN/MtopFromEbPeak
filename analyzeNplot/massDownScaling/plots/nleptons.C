...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.5783133,-28069.25,4.240964,205842);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__29->SetMaximum(203502.9);
   frame__29->SetEntries(37745);
   ...
   mc_stack_5->SetMaximum(164367.7);
   ...
   nleptons_t#bar{t}__30->SetBinContent(6,147131.8);
   nleptons_t#bar{t}__30->SetBinError(6,886.3041);
   nleptons_t#bar{t}__30->SetEntries(29530);
   ...
   nleptons_Diboson__31->SetBinContent(6,737.893);
   nleptons_Diboson__31->SetBinError(6,16.97452);
   nleptons_Diboson__31->SetEntries(2069);
   ...
   nleptons_DY__32->SetBinContent(6,829.3279);
   nleptons_DY__32->SetBinError(6,119.0753);
   nleptons_DY__32->SetEntries(59);
   ...
   nleptons_SinglesPtop__34->SetBinContent(6,7542.276);
   nleptons_SinglesPtop__34->SetBinError(6,100.4595);
   nleptons_SinglesPtop__34->SetEntries(6083);
   ...
   Graph_Graph_from_nleptons3009->SetMaximum(163282.7);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__35->SetEntries(37745);
   ...
   Graph_Graph_from_ratio3010->SetMaximum(1.047015);
