...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(0.2108434,-15009.04,2.620482,110067.2);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__92->SetMaximum(108816.4);
   frame__92->SetEntries(37745);
   ...
   mc_stack_14->SetMaximum(87890.16);
   ...
   nbtags_t#bar{t}__93->SetBinContent(1,66793.4);
   nbtags_t#bar{t}__93->SetBinContent(2,80338.59);
   nbtags_t#bar{t}__93->SetBinError(1,597.4715);
   nbtags_t#bar{t}__93->SetBinError(2,654.6471);
   nbtags_t#bar{t}__93->SetEntries(29530);
   ...
   nbtags_Diboson__94->SetBinContent(1,642.4291);
   nbtags_Diboson__94->SetBinContent(2,95.46381);
   nbtags_Diboson__94->SetBinError(1,15.83995);
   nbtags_Diboson__94->SetBinError(2,6.101652);
   nbtags_Diboson__94->SetEntries(2069);
   ...
   nbtags_SinglesPtop__97->SetBinContent(1,4633.536);
   nbtags_SinglesPtop__97->SetBinContent(2,2908.741);
   nbtags_SinglesPtop__97->SetBinError(1,78.68606);
   nbtags_SinglesPtop__97->SetBinError(2,62.45484);
   nbtags_SinglesPtop__97->SetEntries(6083);
   ...
   Graph_Graph_from_nbtags3027->SetMaximum(88302.31);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__98->SetEntries(37745);
   ...
   Graph_Graph_from_ratio3028->SetMinimum(0.9219118);
   Graph_Graph_from_ratio3028->SetMaximum(0.9678591);
