...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.1445783,-40534.19,1.060241,297251.6);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__113->SetMaximum(293873.7);
   frame__113->SetEntries(119074);
   ...
   mc_stack_17->SetMaximum(237359.5);
   ...
   csv_discriminator_t#bar{t}__114->SetBinContent(0,7265.461);
   csv_discriminator_t#bar{t}__114->SetBinContent(1,212362.4);
   csv_discriminator_t#bar{t}__114->SetBinContent(2,71003.88);
   csv_discriminator_t#bar{t}__114->SetBinContent(3,61413.27);
   csv_discriminator_t#bar{t}__114->SetBinContent(4,120512.2);
   csv_discriminator_t#bar{t}__114->SetBinError(0,196.8845);
   csv_discriminator_t#bar{t}__114->SetBinError(1,1064.415);
   csv_discriminator_t#bar{t}__114->SetBinError(2,615.6471);
   csv_discriminator_t#bar{t}__114->SetBinError(3,572.191);
   csv_discriminator_t#bar{t}__114->SetBinError(4,802.3429);
   csv_discriminator_t#bar{t}__114->SetEntries(94908);
   ...
   csv_discriminator_Diboson__115->SetBinContent(1,1230.507);
   csv_discriminator_Diboson__115->SetBinContent(2,706.7482);
   csv_discriminator_Diboson__115->SetBinContent(3,128.2823);
   csv_discriminator_Diboson__115->SetBinContent(4,67.1269);
   csv_discriminator_Diboson__115->SetBinError(0,3.85304);
   csv_discriminator_Diboson__115->SetBinError(1,21.9365);
   csv_discriminator_Diboson__115->SetBinError(2,16.62634);
   csv_discriminator_Diboson__115->SetBinError(3,7.042889);
   csv_discriminator_Diboson__115->SetBinError(4,5.109786);
   csv_discriminator_Diboson__115->SetEntries(6079);
   ...
   csv_discriminator_DY__116->SetBinContent(1,1248.371);
   csv_discriminator_DY__116->SetBinContent(2,649.3199);
   ...
   csv_discriminator_DY__116->SetEntries(176);
   ...
   csv_discriminator_SinglesPtop__118->SetBinContent(0,343.2727);
   csv_discriminator_SinglesPtop__118->SetBinContent(1,10422.22);
   csv_discriminator_SinglesPtop__118->SetBinContent(2,3651.802);
   csv_discriminator_SinglesPtop__118->SetBinContent(3,2740.705);
   csv_discriminator_SinglesPtop__118->SetBinContent(4,5018.362);
   csv_discriminator_SinglesPtop__118->SetBinError(0,21.65436);
   csv_discriminator_SinglesPtop__118->SetBinError(1,118.036);
   csv_discriminator_SinglesPtop__118->SetBinError(2,69.91017);
   csv_discriminator_SinglesPtop__118->SetBinError(3,60.60463);
   csv_discriminator_SinglesPtop__118->SetBinError(4,81.94447);
   csv_discriminator_SinglesPtop__118->SetEntries(17893);
   ...
   Graph_Graph_from_csv_discriminator3033->SetMaximum(238335.9);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__119->SetEntries(119074);
   ...
   Graph_Graph_from_ratio3034->SetMinimum(0.8865248);
   Graph_Graph_from_ratio3034->SetMaximum(0.9859044);
