...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.07831325,-41659.29,4.740964,305502.3);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__148->SetMaximum(302030.7);
   frame__148->SetEntries(192081);
   ...
   mc_stack_22->SetMaximum(243947.9);
   ...
   cut_flow_t#bar{t}__149->SetBinContent(1,205134.4);
   cut_flow_t#bar{t}__149->SetBinContent(2,169347.3);
   cut_flow_t#bar{t}__149->SetBinContent(3,147197.6);
   cut_flow_t#bar{t}__149->SetBinContent(4,147131.8);
   cut_flow_t#bar{t}__149->SetBinError(1,1046.527);
   cut_flow_t#bar{t}__149->SetBinError(2,950.8118);
   cut_flow_t#bar{t}__149->SetBinError(3,886.4921);
   cut_flow_t#bar{t}__149->SetBinError(4,886.3041);
   cut_flow_t#bar{t}__149->SetEntries(134249);
   ...
   cut_flow_Diboson__150->SetBinContent(3,737.893);
   cut_flow_Diboson__150->SetBinContent(4,737.893);
   cut_flow_Diboson__150->SetBinError(1,45.58919);
   cut_flow_Diboson__150->SetBinError(2,31.66543);
   cut_flow_Diboson__150->SetBinError(3,16.97452);
   cut_flow_Diboson__150->SetBinError(4,16.97452);
   cut_flow_Diboson__150->SetEntries(26405);
   ...
   cut_flow_DY__151->SetBinContent(3,829.3279);
   cut_flow_DY__151->SetBinContent(4,829.3279);
   cut_flow_DY__151->SetBinError(1,345.4941);
   cut_flow_DY__151->SetBinError(2,227.4528);
   cut_flow_DY__151->SetBinError(3,119.0753);
   cut_flow_DY__151->SetBinError(4,119.0753);
   cut_flow_DY__151->SetEntries(772);
   ...
   cut_flow_W__152->SetBinContent(3,299.3656);
   cut_flow_W__152->SetBinContent(4,299.3656);
   cut_flow_W__152->SetBinError(1,288.476);
   cut_flow_W__152->SetBinError(2,228.586);
   cut_flow_W__152->SetBinError(3,159.9003);
   cut_flow_W__152->SetBinError(4,159.9003);
   cut_flow_W__152->SetEntries(31);
   ...
   cut_flow_SinglesPtop__153->SetBinContent(3,7548.928);
   cut_flow_SinglesPtop__153->SetBinContent(4,7542.276);
   cut_flow_SinglesPtop__153->SetBinError(1,135.785);
   cut_flow_SinglesPtop__153->SetBinError(2,110.2191);
   cut_flow_SinglesPtop__153->SetBinError(3,100.5036);
   cut_flow_SinglesPtop__153->SetBinError(4,100.4595);
   cut_flow_SinglesPtop__153->SetEntries(30624);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__154->SetEntries(192081);
   ...
   Graph_Graph_from_ratio3044->SetMinimum(0.9373747);
   Graph_Graph_from_ratio3044->SetMaximum(0.9657667);
