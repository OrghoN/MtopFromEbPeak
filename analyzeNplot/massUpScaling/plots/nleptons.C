...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.5783133,-29678.39,4.240964,217642.3);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__29->SetMaximum(215169.1);
   frame__29->SetEntries(51563);
   ...
   mc_stack_5->SetMaximum(173790.5);
   ...
   nleptons_t#bar{t}__30->SetBinContent(6,156123.1);
   nleptons_t#bar{t}__30->SetBinError(6,777.0018);
   nleptons_t#bar{t}__30->SetEntries(43354);
   ...
   nleptons_Diboson__31->SetBinContent(6,738.509);
   nleptons_Diboson__31->SetBinError(6,16.97739);
   nleptons_Diboson__31->SetEntries(2074);
   ...
   nleptons_SinglesPtop__34->SetBinContent(6,7524.428);
   nleptons_SinglesPtop__34->SetBinError(6,100.3128);
   nleptons_SinglesPtop__34->SetEntries(6073);
   ...
   Graph_Graph_from_nleptons3009->SetMaximum(163290.4);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__35->SetEntries(51563);
   ...
   Graph_Graph_from_ratio3010->SetMaximum(0.9894488);
