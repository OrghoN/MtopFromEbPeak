...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.1445783,-43179.13,1.060241,316647.8);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__113->SetMaximum(313049.5);
   frame__113->SetEntries(164032);
   ...
   mc_stack_17->SetMaximum(252847.7);
   ...
   csv_discriminator_t#bar{t}__114->SetBinContent(0,7611.862);
   csv_discriminator_t#bar{t}__114->SetBinContent(1,227127.9);
   csv_discriminator_t#bar{t}__114->SetBinContent(2,75975.44);
   csv_discriminator_t#bar{t}__114->SetBinContent(3,66415.89);
   csv_discriminator_t#bar{t}__114->SetBinContent(4,126143.5);
   csv_discriminator_t#bar{t}__114->SetBinError(0,171.772);
   csv_discriminator_t#bar{t}__114->SetBinError(1,936.7681);
   csv_discriminator_t#bar{t}__114->SetBinError(2,542.164);
   csv_discriminator_t#bar{t}__114->SetBinError(3,506.7265);
   csv_discriminator_t#bar{t}__114->SetBinError(4,698.4076);
   csv_discriminator_t#bar{t}__114->SetEntries(139901);
   ...
   csv_discriminator_Diboson__115->SetBinContent(0,38.29511);
   csv_discriminator_Diboson__115->SetBinContent(1,1232.652);
   csv_discriminator_Diboson__115->SetBinContent(2,708.7252);
   csv_discriminator_Diboson__115->SetBinContent(3,127.5499);
   csv_discriminator_Diboson__115->SetBinContent(4,63.47318);
   csv_discriminator_Diboson__115->SetBinError(0,3.869412);
   csv_discriminator_Diboson__115->SetBinError(1,21.94995);
   csv_discriminator_Diboson__115->SetBinError(2,16.6502);
   csv_discriminator_Diboson__115->SetBinError(3,7.023778);
   csv_discriminator_Diboson__115->SetBinError(4,4.961448);
   csv_discriminator_Diboson__115->SetEntries(6090);
   ...
   csv_discriminator_SinglesPtop__118->SetBinContent(0,345.9116);
   csv_discriminator_SinglesPtop__118->SetBinContent(1,10405.52);
   csv_discriminator_SinglesPtop__118->SetBinContent(2,3631.846);
   csv_discriminator_SinglesPtop__118->SetBinContent(3,2733.885);
   csv_discriminator_SinglesPtop__118->SetBinContent(4,4999.785);
   csv_discriminator_SinglesPtop__118->SetBinError(0,21.73428);
   csv_discriminator_SinglesPtop__118->SetBinError(1,117.9052);
   csv_discriminator_SinglesPtop__118->SetBinError(2,69.7137);
   csv_discriminator_SinglesPtop__118->SetBinError(3,60.52425);
   csv_discriminator_SinglesPtop__118->SetBinError(4,81.76164);
   csv_discriminator_SinglesPtop__118->SetEntries(17856);
   ...
   Graph_Graph_from_csv_discriminator3033->SetMaximum(238366.7);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__119->SetEntries(164032);
   ...
   Graph_Graph_from_ratio3034->SetMinimum(0.8515278);
   Graph_Graph_from_ratio3034->SetMaximum(0.92311);
