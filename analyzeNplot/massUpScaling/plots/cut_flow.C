...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.07831325,-43261.41,4.740964,317251.2);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__148->SetMaximum(313646.1);
   frame__148->SetEntries(253698);
   ...
   mc_stack_22->SetMaximum(253329.5);
   ...
   cut_flow_t#bar{t}__149->SetBinContent(1,214069.2);
   cut_flow_t#bar{t}__149->SetBinContent(2,179121.3);
   cut_flow_t#bar{t}__149->SetBinContent(3,156225.5);
   cut_flow_t#bar{t}__149->SetBinContent(4,156123.1);
   cut_flow_t#bar{t}__149->SetBinError(1,909.9707);
   cut_flow_t#bar{t}__149->SetBinError(2,832.2557);
   cut_flow_t#bar{t}__149->SetBinError(3,777.2603);
   cut_flow_t#bar{t}__149->SetBinError(4,777.0018);
   cut_flow_t#bar{t}__149->SetEntries(195878);
   ...
   cut_flow_Diboson__150->SetBinContent(3,738.509);
   cut_flow_Diboson__150->SetBinContent(4,738.509);
   cut_flow_Diboson__150->SetBinError(1,45.58919);
   cut_flow_Diboson__150->SetBinError(2,31.66543);
   cut_flow_Diboson__150->SetBinError(3,16.97739);
   cut_flow_Diboson__150->SetBinError(4,16.97739);
   cut_flow_Diboson__150->SetEntries(26415);
   ...
   cut_flow_DY__151->SetBinContent(3,829.2936);
   cut_flow_DY__151->SetBinContent(4,829.2936);
   cut_flow_DY__151->SetBinError(1,345.4941);
   cut_flow_DY__151->SetBinError(2,227.4528);
   cut_flow_DY__151->SetBinError(3,119.0752);
   cut_flow_DY__151->SetBinError(4,119.0752);
   cut_flow_DY__151->SetEntries(770);
   ...
   cut_flow_SinglesPtop__153->SetBinContent(3,7531.08);
   cut_flow_SinglesPtop__153->SetBinContent(4,7524.428);
   cut_flow_SinglesPtop__153->SetBinError(1,135.785);
   cut_flow_SinglesPtop__153->SetBinError(2,110.2191);
   cut_flow_SinglesPtop__153->SetBinError(3,100.357);
   cut_flow_SinglesPtop__153->SetBinError(4,100.3128);
   cut_flow_SinglesPtop__153->SetEntries(30604);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__154->SetEntries(253698);
   ...
   Graph_Graph_from_ratio3044->SetMinimum(0.8856844);
   Graph_Graph_from_ratio3044->SetMaximum(0.9309117);
