...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(0.2108434,-15959.59,2.620482,117037.8);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__92->SetMaximum(115707.8);
   frame__92->SetEntries(51563);
   ...
   mc_stack_14->SetMaximum(93456.32);
   ...
   nbtags_t#bar{t}__93->SetBinContent(1,70468.55);
   nbtags_t#bar{t}__93->SetBinContent(2,85654.66);
   nbtags_t#bar{t}__93->SetBinError(1,522.0123);
   nbtags_t#bar{t}__93->SetBinError(2,575.5302);
   nbtags_t#bar{t}__93->SetEntries(43354);
   ...
   nbtags_Diboson__94->SetBinContent(1,645.753);
   nbtags_Diboson__94->SetBinContent(2,92.75591);
   nbtags_Diboson__94->SetBinError(1,15.8787);
   nbtags_Diboson__94->SetBinError(2,6.008212);
   nbtags_Diboson__94->SetEntries(2074);
   ...
   nbtags_DY__95->SetBinContent(1,690.2245);
   nbtags_DY__95->SetBinContent(2,139.069);
   nbtags_DY__95->SetBinError(1,108.4051);
   nbtags_DY__95->SetBinError(2,49.26706);
   ...
   nbtags_SinglesPtop__97->SetBinContent(1,4611.188);
   nbtags_SinglesPtop__97->SetBinContent(2,2913.242);
   nbtags_SinglesPtop__97->SetBinError(1,78.4795);
   nbtags_SinglesPtop__97->SetBinError(2,62.47896);
   nbtags_SinglesPtop__97->SetEntries(6073);
   ...
   Graph_Graph_from_nbtags3027->SetMaximum(88295.7);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__98->SetEntries(51563);
   ...
   Graph_Graph_from_ratio3028->SetMinimum(0.880257);
   Graph_Graph_from_ratio3028->SetMaximum(0.907749);
