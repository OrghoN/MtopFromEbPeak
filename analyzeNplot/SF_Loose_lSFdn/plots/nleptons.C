...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(-0.5783133,-28699.71,4.240964,210465.4);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__29->SetMaximum(208073.8);
   frame__29->SetEntries(402125);
   ...
   mc_stack_5->SetMaximum(168059.6);
   ...
   nleptons_t#bar{t}__30->SetBinContent(6,150672.9);
   nleptons_t#bar{t}__30->SetBinError(6,248.7935);
   nleptons_t#bar{t}__30->SetEntries(393927);
   ...
   nleptons_Diboson__31->SetBinContent(6,736.6461);
   nleptons_Diboson__31->SetBinError(6,16.95717);
   nleptons_Diboson__31->SetEntries(2066);
   ...
   nleptons_DY__32->SetBinContent(6,829.2936);
   nleptons_DY__32->SetBinError(6,119.0752);
   nleptons_DY__32->SetEntries(58);
   ...
   nleptons_W__33->SetBinContent(6,299.3656);
   nleptons_W__33->SetBinError(6,159.9003);
   nleptons_W__33->SetEntries(4);
   ...
   nleptons_SinglesPtop__34->SetBinContent(6,7518.544);
   nleptons_SinglesPtop__34->SetBinError(6,100.2639);
   nleptons_SinglesPtop__34->SetEntries(6070);
   ...
   Graph_Graph_from_nleptons3009->SetMaximum(163238.6);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__35->SetEntries(402125);
   ...
   Graph_Graph_from_ratio3010->SetMaximum(1.020629);
