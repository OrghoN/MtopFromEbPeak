...
// ------------>Primitives in pad: p1
   ...
   p1->Draw();
   p1->cd();
   p1->Range(0.2108434,-15427.44,2.620482,113135.4);
   p1->SetFillColor(0);
   p1->SetBorderMode(0);
   p1->SetBorderSize(2);
   p1->SetGridx();
   ...
   frame__92->SetMaximum(111849.7);
   frame__92->SetEntries(402125);
   ...
   mc_stack_14->SetMaximum(90340.18);
   ...
   nbtags_t#bar{t}__93->SetBinContent(1,67978.54);
   nbtags_t#bar{t}__93->SetBinContent(2,82695.38);
   nbtags_t#bar{t}__93->SetBinError(1,167.1138);
   nbtags_t#bar{t}__93->SetBinError(2,184.3127);
   nbtags_t#bar{t}__93->SetEntries(393927);
   ...
   nbtags_Diboson__94->SetBinContent(1,642.3748);
   nbtags_Diboson__94->SetBinContent(2,94.27126);
   nbtags_Diboson__94->SetBinError(1,15.83877);
   nbtags_Diboson__94->SetBinError(2,6.056333);
   nbtags_Diboson__94->SetEntries(2066);
   ...
   nbtags_DY__95->SetBinContent(1,690.9848);
   nbtags_DY__95->SetBinContent(2,138.3087);
   nbtags_DY__95->SetBinError(1,108.5254);
   nbtags_DY__95->SetBinError(2,49.00164);
   nbtags_DY__95->SetEntries(58);
   ...
   nbtags_W__96->SetBinContent(1,93.08335);
   nbtags_W__96->SetBinContent(2,206.2823);
   nbtags_W__96->SetBinError(1,93.08335);
   nbtags_W__96->SetBinError(2,130.0138);
   nbtags_W__96->SetEntries(4);
   ...
   nbtags_SinglesPtop__97->SetBinContent(1,4614.519);
   nbtags_SinglesPtop__97->SetBinContent(2,2904.026);
   nbtags_SinglesPtop__97->SetBinError(1,78.50271);
   nbtags_SinglesPtop__97->SetBinError(2,62.37129);
   nbtags_SinglesPtop__97->SetEntries(6070);
   ...
   Graph_Graph_from_nbtags3027->SetMaximum(88062.09);
...
// ------------>Primitives in pad: p2
   ...
   ratioframe__98->SetEntries(402125);
   ...
   Graph_Graph_from_ratio3028->SetMinimum(0.9159393);
   Graph_Graph_from_ratio3028->SetMaximum(0.9327682);
